...
export default function RiskMatrix({ filters }) {
  ...
  useEffect(() => {
    axios
      ...
      .catch(() => {
        setError("Failed to load risk matrix.");
        setIsLoading(false);
      });
  }, [filters]);
  ...
  return (
    <div
      className="
        ...
        p-6 transition-all hover:shadow-2xl hover:border-orange-300/50
      "
    >
      <h2 className="text-2xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
        ⚠️ Risk Matrix (Quadrant Analysis)
      </h2>
